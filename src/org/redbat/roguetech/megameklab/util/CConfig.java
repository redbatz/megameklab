...
public class CConfig {
    ...
    public static final String CONFIG_ROGUETECH_ROGUETECH_DIRECTORY = "Roguetech-Directory";
    public static final String CONFIG_ROGUETECH_CAB_DIRECTORY = "CAB-Directory";
    public static final String CONFIG_ROGUETECH_BATTLETECH_DIRECTORY = "Battletech-Directory";
    public static final String CONFIG_ROGUETECH_HBS_DIRECTORY = "HBS-Directory";
    ...
    public static boolean isRoguetechConfigSet() {
        String roguetechParam = CConfig.getParam(CConfig.CONFIG_ROGUETECH_ROGUETECH_DIRECTORY);
        String battletechParam = CConfig.getParam(CConfig.CONFIG_ROGUETECH_BATTLETECH_DIRECTORY);
        String cabParam = CConfig.getParam(CConfig.CONFIG_ROGUETECH_CAB_DIRECTORY);
        String hbsParam = CConfig.getParam(CConfig.CONFIG_ROGUETECH_HBS_DIRECTORY);

        return !roguetechParam.isEmpty() && !battletechParam.isEmpty() && !cabParam.isEmpty() && !hbsParam.isEmpty();
    }
}
